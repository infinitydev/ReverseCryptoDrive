    ...
    class Proxy
    {
            ...
            ref DOKAN_FILE_INFO rawFileInfo)
        {
            try
            {
                ...
                int ret = operations_.CreateFile(file, access, share, mode, rawFlagsAndAttributes, info);
            ...
            ref DOKAN_FILE_INFO rawFileInfo)
        {
            try
            {
                ...
                int ret = operations_.GetFileInformation(file, ref rawHandleFileInformation, GetFileInfo(ref rawFileInfo));
        ...
        {
            public Delimon.Win32.IO.FileAttributes dwFileAttributes;
            public ComTypes.FILETIME ftCreationTime;
            public ComTypes.FILETIME ftLastAccessTime;
            public ComTypes.FILETIME ftLastWriteTime;
            public uint nFileSizeHigh;
