    ...
    public class ByteBuffer
    {
        ...
        public byte[] ReadBytes(int length)
        {
            if (_Capacity >= _Position + length)
            {
                ...
                System.Array.Copy(_Buffer, _Position, temp, 0, length);
                _Position += length;
                return temp;
            }
            return null;
        ...
        public void ReadBytes(byte[] buffer, int bufferOffset, int length)
        {
            if (_Capacity >= _Position + length)
            {
                System.Array.Copy(_Buffer, _Position, buffer, bufferOffset, length);
                _Position += length;
            }
        }
        /// <summary>
        ...
        public void WriteBytes(byte[] val)
        {
            ...
            {
                System.Array.Copy(val, 0, _Buffer, _Position, val.Length);
